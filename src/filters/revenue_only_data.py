...
reader = csv.reader(open("../data/movies/movie_data.csv"), delimiter=',')
data_writer = csv.writer(open("../data/movies/revenue_only_data.csv", "a+"))
url_writer = csv.writer(open("../data/urls/the_numbers_movie_urls.csv", "a+"))
